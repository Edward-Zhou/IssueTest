...
namespace BlankApp1.ViewModels
{
    public class MainPageViewModel : ViewModelBase
    {
        ...
        #endregion
        #region Non-api related members
        ...
        public static SpriteVisual visual;
        #endregion
        ...
        public DelegateCommand StartCapture =>
            _startCapture ?? (_startCapture = new DelegateCommand(ExecuteStartCapture));

        async void ExecuteStartCapture()
        {
            await StartCaptureAsync();
        }
        private DelegateCommand _saveImage;
        public DelegateCommand SaveImage =>
            _saveImage ?? (_saveImage = new DelegateCommand(ExecuteSaveImage));

        async void ExecuteSaveImage()
        {
